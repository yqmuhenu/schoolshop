$(function () {
    ...
    var infoUrl = '/schoolshop/product/getproductbyid?productId=' + productId;
    //获取当前店铺设定的商品类别列表的URL
    var categoryUrl = '/schoolshop/productcategory/getproductcategorylist';
    //更新商品信息的URL
    var productPostUrl = '/schoolshop/product/modifyproduct';
    //由于商品添加和编辑使用的是同一个页面，
    //该标识符用来标明本次时添加还是编辑操作
    var isEdit = false;
    if (productId) {
        ...
        getCategory();
        productPostUrl = '/schoolshop/product/addproduct';
    }
        ...
        $.getJSON(
            ...
            function (data) {
                if (data.success) {
                    ...
                    //获取原本的商品类别（productCategoryId）以及该店铺的所有商品类别列表
                    var optionHtml = '';
                    var optionArr = data.productCategoryList;
                    var optionSelected = product.productCategory == null ?
